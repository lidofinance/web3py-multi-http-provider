...
_NOT_AVAILABLE_ADDRESS_1 = 'http://127.0.0.1:9001'
_NOT_AVAILABLE_ADDRESS_2 = 'http://127.0.0.1:9002'

_AVAILABLE_ADDRESS = 'http://127.0.0.1:9000'
...
async def mocked_async_request_get(
    ...
    **kwargs,
    ...
    if _AVAILABLE_ADDRESS in endpoint_uri:
...
def mock_response(
    endpoint_uri,
    body=_MOCK_REQUEST_GET_RESULT,
) -> requests.Response:
    if _AVAILABLE_ADDRESS not in endpoint_uri:
        raise ConnectionError("Mocked connection error.")
