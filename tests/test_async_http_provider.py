...
class HttpProviderTestCase(TestCase):
    ...
    @pytest.mark.asyncio
    @patch("web3._utils.http_session_manager.HTTPSessionManager.async_make_post_request", side_effect=mocked_requests_get)
    ...
    @pytest.mark.asyncio
    @patch("web3._utils.http_session_manager.HTTPSessionManager.async_make_post_request", side_effect=mocked_request_poa)
